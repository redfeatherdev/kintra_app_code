...
@media_bp.route('/upload/blog', methods=['POST'])
def upload_blog():
...
@media_bp.route('/upload/banner', methods=['POST'])
def upload_banner():
    file = request.files.get('file')
...
@media_bp.route('/media/active', methods=['GET'])
...
@media_bp.route('/media/delete/<media_id>', methods=['DELETE'])
...
@media_bp.route('/blog/active', methods=['GET'])
...
@media_bp.route('/banner/active', methods=['GET'])
