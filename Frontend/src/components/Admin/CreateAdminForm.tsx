...
const CreateAdminForm = ({ fetchData }: { fetchData: () => void }) => {
    ...
    if (Object.keys(errors).length === 0) {
      try {
        ...
        const res = await axios.post(
          `${import.meta.env.VITE_API_URL}/api/v1/add_admin`,
          {
    ...
    <Flex direction="col" align="stretch" className="gap-0 p-6 pb-24">
      <div className="flex flex-col items-stretch gap-5">
        <Input
          ...
          inputClassName={`${formik.touched.name && formik.errors.name
        ...
        <Input
          ...
          errorClassName="text-red-500 text-xs ml-1"
          inputClassName={`${formik.touched.email && formik.errors.email
              ? 'border-red-400 [&.is-hover]:border-red-400 [&.is-focus]:ring-red-500 [&.is-focus]:border-red-400'
              : ''
            }`}
        />
        ...
        <Password
          ...
          errorClassName="text-red-500 text-xs ml-1"
          inputClassName={`${formik.touched.password && formik.errors.password
              ? 'border-red-400 [&.is-hover]:border-red-400 [&.is-focus]:ring-red-500 [&.is-focus]:border-red-400'
              : ''
            }`}
        />
        ...
        <Password
          ...
          className="dark:[&_.rizzui-password-container]:border-gray-700 dark:[&_.rizzui-password-container]:ring-0"
          errorClassName="text-red-500 text-xs ml-1"
          inputClassName={`${formik.touched.confirmPassword && formik.errors.confirmPassword
              ? 'border-red-400 [&.is-hover]:border-red-400 [&.is-focus]:ring-red-500 [&.is-focus]:border-red-400'
              : ''
            }`}
        />
