  ...
  return (
    <div className="flex flex-col bg-white dark:bg-boxdark border border-stroke dark:border-strokedark p-3">
      ...
      <div className="flex items-center gap-2 mt-3 px-3">
        <span className="font-bold text-black dark:text-white">Male Popular Skin Color: </span>
        <span className="text-black dark:text-white">{data[period].top_skin_colors.Man[0]}</span>
      </div>
      <div className="flex gap-3 px-4 mt-1">
        <div className="items-center">
          <span className="text-sm font-semibold text-black dark:text-white">2: </span>
          <span className="text-sm">{data[period].top_skin_colors.Man[1]}</span>
        </div>
        <div className="items-center">
          <span className="text-sm font-semibold text-black dark:text-white">3: </span>
          <span className="text-sm">{data[period].top_skin_colors.Man[2]}</span>
        </div>
        <div className="items-center">
          <span className="text-sm font-semibold text-black dark:text-white">4: </span>
          <span className="text-sm">{data[period].top_skin_colors.Man[3]}</span>
        </div>
      </div>
      <div className="flex items-center gap-2 mt-2 px-3">
        <span className="font-bold text-black dark:text-white">Female Popular Skin Color: </span>
        <span className="text-black">{data[period].top_skin_colors.Woman[0]}</span>
      </div>
      <div className="flex gap-3 px-4 mt-1">
        <div className="items-center">
          <span className="text-sm font-semibold text-black dark:text-white">2: </span>
          <span className="text-sm">{data[period].top_skin_colors.Woman[1]}</span>
        </div>
        <div className="items-center">
          <span className="text-sm font-semibold text-black dark:text-white">3: </span>
          <span className="text-sm">{data[period].top_skin_colors.Woman[2]}</span>
        </div>
        <div className="items-center">
          <span className="text-sm font-semibold text-black dark:text-white">4: </span>
          <span className="text-sm">{data[period].top_skin_colors.Woman[3]}</span>
        </div>
      </div>
    </div>
  )
...
export default PopularSkinColors;