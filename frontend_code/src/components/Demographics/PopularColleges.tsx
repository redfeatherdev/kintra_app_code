  ...
  return (
    <div className="flex flex-col bg-white dark:bg-boxdark border border-stroke dark:border-strokedark p-3">
      ...
      <div className="flex items-center gap-2 mt-3 px-3">
        <span className="font-bold text-black dark:text-white">Most Popular College: </span>
        <span className="text-black dark:text-white">{data[period].top_colleges[0]}</span>
      </div>
      <div className="flex flex-col gap-1 px-4 mt-2">
        <div className="items-center">
          <span className="text-sm font-semibold text-black dark:text-white">2: </span>
          <span className="text-sm">{data[period].top_colleges[1]}</span>
        </div>
        <div className="items-center">
          <span className="text-sm font-semibold text-black dark:text-white">3: </span>
          <span className="text-sm">{data[period].top_colleges[2]}</span>
        </div>
        <div className="items-center">
          <span className="text-sm font-semibold text-black dark:text-white">4: </span>
          <span className="text-sm">{data[period].top_colleges[3]}</span>
        </div>
      </div>
    </div>
  )
